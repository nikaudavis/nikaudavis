...
function setup() {
  ...
  textSize(fontSize);
  text("Out in my garden is a portal. I’ve decorated it and made it feel at home by planting cabbages and broad beans all around it. I can walk through it and find my way to a place that matches my mood - it reads my biorhythms and knows whether I need to emerge in a brooding forest, violent surf, or an alley behind my old primary school. And if I want to return here, I just eat a plate of cabbage and broad beans.", w/9, h/9, w/9*7)
