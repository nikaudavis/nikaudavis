...
function setup() {
  ...
  rect(0, 0, w, h);
    ...
    let artistStatement = ['"Out In My Garden" (2023) is an internet artwork inspired by an anonymous submission to a previous work, “Blueprints” (2023). It interrogates powerful collective feelings of longing and hope for the inaccessible, presenting a speculative world in which transportational portals have spontaneously appeared globally. Their fantasy and sci-fi implications interrogate popular perceptions of utopia as an unattainable, mythical destination, while encouraging the audience to indulge in imagination and fancy. Portals symbolise digital spaces as interconnective stages for emotional connection and social productivity, exploring the positive potential of a post-capitalist globalised world, nurturing the internet into a realm of utopic possibility. The work appropriates various online textual forms and aesthetics (personal blogs, government forms, and clickbait), glorifying the construction and exploration of maximalist digital spaces. Euphoric digital collages hinder legibility, playing on utopia’s inaccessibility, mirroring the fluctuating clarity of visions of the future. The site generates randomly upon each reload, providing unique journeys to each viewer progressing through the work, becoming a portal in and of itself.\n\nAcknowledgements\nThank you to Clare Todorovitch, Joshua Smith, Minna Squire, Honeybee O’Gee, Phoenix O’Connell, Liam McCombie, Ruby Kingham, Alana Hunt, Zoe Davis, Sarah Davis, Seamus Burne, David Bulger and Bailey Ayre for submitting drawings of your portals <3']
